...
public class LCO_UtilsDNC
{
	...
	public static String getFullName(String fn1, String ln1, int AD_Client_ID) {
		...
		String nameSeparator = MSysConfig.getValue("QSSLCO_NameSeparatorContact", " ", AD_Client_ID);
		boolean namesFirst = MSysConfig.getBooleanValue("QSSLCO_NamesFirstContact", true, AD_Client_ID);
