...
public class LEC_FE_MRetencion extends MInvoice
{
	...
	public String lecfeinvret_SriExportRetencionXML100 ()
	{
		...
		// Access Code
		m_accesscode = LEC_FE_Utils.getAccessCode(getDateInvoiced(), m_coddoc, bpe.getTaxID(), m_tipoambiente, oi.get_ValueAsString("SRI_OrgCode"), LEC_FE_Utils.getStoreCode(LEC_FE_Utils.formatDocNo(getDocumentNo(), m_coddoc)), m_retencionno, oi.get_ValueAsString("SRI_DocumentCode"), m_tipoemision);
