...
@XmlRootElement(name = "GetStatusZip")
public class GetStatusZip {

    @XmlElementRef(name = "trackId", namespace = "http://wcf.dian.colombia", type = JAXBElement.class, required = false)
